// 20 Pad Logic logo concepts — SVG, all code-native, no external assets
...
export const LOGOS = [
  ...
  L('logo-03', 'Tech Circuit', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="52" y="21" fontFamily={FB} fontSize="16" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="84" y="38" fontFamily={FB} fontSize="28" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-04', 'Hexagon Badge', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="52" y="22" fontFamily={FB} fontSize="16" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="86" y="40" fontFamily={FB} fontSize="26" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-05', 'Wellhead Icon', (size) => (
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="90" y="40" fontFamily={FB} fontSize="26" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-06', 'Data Pulse', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      <text x="4" y="30" fontFamily={FB} fontSize="22" fill={W} letterSpacing="2">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      <text x="4" y="46" fontFamily={FB} fontSize="36" fill={W} letterSpacing="3">PAD LOGIC</text>
      <polyline
  ...
  L('logo-08', 'Gear Mechanical', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="46" y="22" fontFamily={FB} fontSize="16" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="74" y="40" fontFamily={FB} fontSize="26" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-09', 'Shield Emblem', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="50" y="22" fontFamily={FB} fontSize="16" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="82" y="40" fontFamily={FB} fontSize="26" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-10', 'Chevron Arrow', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="38" y="22" fontFamily={FB} fontSize="16" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="56" y="42" fontFamily={FB} fontSize="28" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-11', 'Oilfield Derrick', (size) => (
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="84" y="40" fontFamily={FB} fontSize="26" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-12', 'Compression Wave', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="60" y="22" fontFamily={FB} fontSize="16" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="96" y="42" fontFamily={FB} fontSize="26" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-13', 'Terminal / Code', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="20" y="35" fontFamily="'Courier New', Courier, monospace" fontSize="16" fill={W}>PAD_LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="36" y="56" fontFamily="'Courier New', Courier, monospace" fontSize="28" fill={W}>PAD_LOGIC</text>
  ...
  L('logo-16', 'Bracket System', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="18" y="30" fontFamily={FB} fontSize="18" fill={W} letterSpacing="1">PAD LOGIC</text>
    ...
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      ...
      <text x="28" y="52" fontFamily={FB} fontSize="30" fill={W} letterSpacing="2">PAD LOGIC</text>
  ...
  L('logo-20', 'Minimal Dot', (size) => (
    <svg height={size} viewBox="0 0 220 48" style={{ height: size, width: 'auto' }}>
      ...
      <text x="20" y="20" fontFamily={FB} fontSize="22" fill={W} letterSpacing="3">PAD LOGIC</text>
      <text x="20" y="36" fontFamily={FM} fontSize="9" fill={G} letterSpacing="5">THE NIGHT CREW</text>
    </svg>
  ), (size) => (
    <svg height={size} viewBox="0 0 320 80" style={{ height: size, width: 'auto' }}>
      <circle cx="12" cy="18" r="10" fill={R} />
      <text x="30" y="34" fontFamily={FB} fontSize="36" fill={W} letterSpacing="4">PAD LOGIC</text>
