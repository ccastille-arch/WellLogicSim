...
const TUTORIAL_STEPS = [
  {
    ...
    description: 'Each row represents one well\'s injection choke valve. The WellLogic panel controls these choke valves to regulate the amount of gas injected into each well. This is the primary control mechanism for gas lift optimization.',
    position: 'bottom',
  },
  {
    selector: '[data-tutorial="choke-manual-0"]',
    title: 'Manual Setpoint (SP)',
    description: 'This is the operator\'s manual setpoint for the choke valve position (0–100%). Use the ↓ and ↑ arrows to adjust. In Auto mode, the WellLogic optimizer will override this value. In Manual mode, this value directly controls the valve.',
    position: 'bottom',
  },
  {
